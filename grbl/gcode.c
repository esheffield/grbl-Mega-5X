...
uint8_t gc_execute_line(char *line)
{
  ...
  { // Loop until no more g-code words in line.
    ...
    case 'G':
      ...
      if (bit_istrue(command_dwords, dwbit(dword_bit)))
      {
    ...
    default:
      ...
      case 'I':
        ...
        if (AXIS_1_NAME == 'X')
        {
          gc_block.values.ijk[AXIS_1] = value;
          ijk_words |= (1 << AXIS_1);
        }
        if (AXIS_2_NAME == 'X')
        {
          gc_block.values.ijk[AXIS_2] = value;
          ijk_words |= (1 << AXIS_2);
        }
        if (AXIS_3_NAME == 'X')
        {
          gc_block.values.ijk[AXIS_3] = value;
          ijk_words |= (1 << AXIS_3);
        }
#ifdef AXIS_4
        if (AXIS_4_NAME == 'X')
        {
          gc_block.values.ijk[AXIS_4] = value;
          ijk_words |= (1 << AXIS_4);
        }
#endif
#ifdef AXIS_5
        if (AXIS_5_NAME == 'X')
        {
          gc_block.values.ijk[AXIS_5] = value;
          ijk_words |= (1 << AXIS_5);
        }
#endif
#ifdef AXIS_6
        if (AXIS_6_NAME == 'X')
        {
          gc_block.values.ijk[AXIS_6] = value;
          ijk_words |= (1 << AXIS_6);
        }
#endif
        break;
      ...
      default:
        ...
        {
          dword_bit = DWORD_X;
          gc_block.values.xyz[AXIS_1] = value;
          axis_dwords |= (1 << AXIS_1);
        }
        if (letter == AXIS_2_NAME)
        {
          dword_bit = DWORD_Y;
          gc_block.values.xyz[AXIS_2] = value;
          axis_dwords |= (1 << AXIS_2);
        }
        if (letter == AXIS_3_NAME)
        {
          dword_bit = DWORD_Z;
          gc_block.values.xyz[AXIS_3] = value;
          axis_dwords |= (1 << AXIS_3);
        }
#ifdef AXIS_4
        if (letter == AXIS_4_NAME)
        {
          dword_bit = DWORD_A;
          gc_block.values.xyz[AXIS_4] = value;
          axis_dwords |= (1 << AXIS_4);
        }
#endif
#ifdef AXIS_5
        ...
        {
          dword_bit = DWORD_B;
          gc_block.values.xyz[AXIS_5] = value;
          axis_dwords |= (1 << AXIS_5);
        }
#endif
#ifdef AXIS_6
        ...
        {
          dword_bit = DWORD_C;
          gc_block.values.xyz[AXIS_6] = value;
          axis_dwords |= (1 << AXIS_6);
        }
#endif
      ...
      if (bit_istrue(value_dwords, dwbit(dword_bit)))
      {
  ...
  */
  ...
  if (gc_parser_flags & GC_PARSER_JOG_MOTION)
  {
    if (bit_isfalse(value_dwords, dwbit(DWORD_F)))
    {
  ...
  if (bit_isfalse(value_dwords, dwbit(DWORD_S)))
  {
...
// [9. Override control ]: Not supported except for a Grbl-only parking motion override control.
#ifdef ENABLE_PARKING_OVERRIDE_CONTROL
  if (bit_istrue(command_dwords, dwbit(MODAL_GROUP_M9)))
  ...
  {
    if (bit_isfalse(value_dwords, dwbit(DWORD_P)))
    {
  ...
  case PLANE_SELECT_XY: /* axis_0 = X axis, axis_1 = Y axis, axis_linear = Z axis */
    if (AXIS_1_NAME == 'X')
    {
      axis_0_mask |= (1 << AXIS_1);
      axis_0 = AXIS_1;
    }
    if (AXIS_2_NAME == 'X')
    {
      axis_0_mask |= (1 << AXIS_2);
      axis_0 = AXIS_2;
    }
    if (AXIS_3_NAME == 'X')
    {
      axis_0_mask |= (1 << AXIS_3);
      axis_0 = AXIS_3;
    }
#ifdef AXIS_4
    if (AXIS_4_NAME == 'X')
    {
      axis_0_mask |= (1 << AXIS_4);
      axis_0 = AXIS_4;
    }
#endif
#ifdef AXIS_5
    ...
    if (AXIS_1_NAME == 'Y')
    {
      axis_1_mask |= (1 << AXIS_1);
      axis_1 = AXIS_1;
    }
    if (AXIS_2_NAME == 'Y')
    {
      axis_1_mask |= (1 << AXIS_2);
      axis_1 = AXIS_2;
    }
    if (AXIS_3_NAME == 'Y')
    {
      axis_1_mask |= (1 << AXIS_3);
      axis_1 = AXIS_3;
    }
#ifdef AXIS_4
    if (AXIS_4_NAME == 'Y')
    {
      axis_1_mask |= (1 << AXIS_4);
      axis_1 = AXIS_4;
    }
#endif
#ifdef AXIS_5
    ...
    if (AXIS_1_NAME == 'Z')
    {
      axis_linear_mask |= (1 << AXIS_1);
      axis_linear = AXIS_1;
    }
    if (AXIS_2_NAME == 'Z')
    {
      axis_linear_mask |= (1 << AXIS_2);
      axis_linear = AXIS_2;
    }
    if (AXIS_3_NAME == 'Z')
    {
      axis_linear_mask |= (1 << AXIS_3);
      axis_linear = AXIS_3;
    }
#ifdef AXIS_4
    if (AXIS_4_NAME == 'Z')
    {
      axis_linear_mask |= (1 << AXIS_4);
      axis_linear = AXIS_4;
    }
    else if (AXIS_4_NAME == 'A')
    {
      axis_a_mask |= (1 << AXIS_4);
      axis_a = AXIS_4;
    }
    else if (AXIS_4_NAME == 'B')
    {
      axis_b_mask |= (1 << AXIS_4);
      axis_b = AXIS_4;
    }
    else if (AXIS_4_NAME == 'C')
    {
      axis_c_mask |= (1 << AXIS_4);
      axis_c = AXIS_4;
    }
    else if (AXIS_4_NAME == 'U')
    {
      axis_u_mask |= (1 << AXIS_4);
      axis_u = AXIS_4;
    }
    else if (AXIS_4_NAME == 'V')
    {
      axis_v_mask |= (1 << AXIS_4);
      axis_v = AXIS_4;
    }
    else if (AXIS_4_NAME == 'W')
    {
    ...
    if (AXIS_5_NAME == 'Z')
    {
      axis_linear_mask |= (1 << AXIS_5);
      axis_linear = AXIS_5;
    }
    else if (AXIS_5_NAME == 'A')
    {
      axis_a_mask |= (1 << AXIS_5);
      axis_a = AXIS_5;
    }
    else if (AXIS_5_NAME == 'B')
    {
      axis_b_mask |= (1 << AXIS_5);
      axis_b = AXIS_5;
    }
    else if (AXIS_5_NAME == 'C')
    {
      axis_c_mask |= (1 << AXIS_5);
      axis_c = AXIS_5;
    }
    else if (AXIS_5_NAME == 'U')
    {
      axis_u_mask |= (1 << AXIS_5);
      axis_u = AXIS_5;
    }
    else if (AXIS_5_NAME == 'V')
    {
      axis_v_mask |= (1 << AXIS_5);
      axis_v = AXIS_5;
    }
    else if (AXIS_5_NAME == 'W')
    {
    ...
    if (AXIS_6_NAME == 'Z')
    {
      axis_linear_mask |= (1 << AXIS_6);
      axis_linear = AXIS_6;
    }
    else if (AXIS_6_NAME == 'A')
    {
      axis_a_mask |= (1 << AXIS_6);
      axis_a = AXIS_6;
    }
    else if (AXIS_6_NAME == 'B')
    {
      axis_b_mask |= (1 << AXIS_6);
      axis_b = AXIS_6;
    }
    else if (AXIS_6_NAME == 'C')
    {
      axis_c_mask |= (1 << AXIS_6);
      axis_c = AXIS_6;
    }
    else if (AXIS_6_NAME == 'U')
    {
      axis_u_mask |= (1 << AXIS_6);
      axis_u = AXIS_6;
    }
    else if (AXIS_6_NAME == 'V')
    {
      axis_v_mask |= (1 << AXIS_6);
      axis_v = AXIS_6;
    }
    else if (AXIS_6_NAME == 'W')
    {
  ...
  { // Indicates called in block.
    ...
    {
      if (axis_dwords ^ (1 << TOOL_LENGTH_OFFSET_AXIS))
      {
  ...
  if (bit_istrue(command_dwords, bit(MODAL_GROUP_G12)))
  ...
  case NON_MODAL_SET_COORDINATE_DATA:
    ...
    if (bit_isfalse(value_dwords, ((1 << DWORD_P) | (1 << DWORD_L))))
    {
      FAIL(STATUS_GCODE_VALUE_WORD_MISSING);
    }                                        // [P/L word missing]
    ...
    if (gc_block.values.l != 20)
    {
      ...
      {
        if (bit_istrue(value_dwords, dwbit(DWORD_R)))
        {
          FAIL(STATUS_GCODE_UNSUPPORTED_COMMAND);
  ...
  else if (axis_command == AXIS_COMMAND_MOTION_MODE)
  {
    ...
    else
    {
      ...
      case MOTION_MODE_CCW_ARC:
        ...
        if (!(axis_dwords & (bit(axis_0) | bit(axis_1))))
        {
        ...
        { // Arc Radius Mode
          ...
          case PLANE_SELECT_XY:
            if (AXIS_1_NAME == 'X')
            {
              gc_block.values.ijk[AXIS_1] = 0.5 * (x - (y * h_x2_div_d));
            }
            if (AXIS_2_NAME == 'X')
            {
              gc_block.values.ijk[AXIS_2] = 0.5 * (x - (y * h_x2_div_d));
            }
            if (AXIS_3_NAME == 'X')
            {
              gc_block.values.ijk[AXIS_3] = 0.5 * (x - (y * h_x2_div_d));
            }
#ifdef AXIS_4
            if (AXIS_4_NAME == 'X')
            {
              gc_block.values.ijk[AXIS_4] = 0.5 * (x - (y * h_x2_div_d));
            }
#endif
#ifdef AXIS_5
            if (AXIS_5_NAME == 'X')
            {
              gc_block.values.ijk[AXIS_5] = 0.5 * (x - (y * h_x2_div_d));
            }
#endif
#ifdef AXIS_6
            if (AXIS_6_NAME == 'X')
            {
              gc_block.values.ijk[AXIS_6] = 0.5 * (x - (y * h_x2_div_d));
            }
#endif
            if (AXIS_1_NAME == 'Y')
            {
            ...
            if (AXIS_2_NAME == 'Y')
            {
              gc_block.values.ijk[AXIS_2] = 0.5 * (y + (x * h_x2_div_d));
            }
            if (AXIS_3_NAME == 'Y')
            {
              gc_block.values.ijk[AXIS_3] = 0.5 * (y + (x * h_x2_div_d));
            }
#ifdef AXIS_4
            if (AXIS_4_NAME == 'Y')
            {
              gc_block.values.ijk[AXIS_4] = 0.5 * (y + (x * h_x2_div_d));
            }
#endif
#ifdef AXIS_5
            if (AXIS_5_NAME == 'Y')
            {
              gc_block.values.ijk[AXIS_5] = 0.5 * (y + (x * h_x2_div_d));
            }
#endif
#ifdef AXIS_6
            if (AXIS_6_NAME == 'Y')
            {
              gc_block.values.ijk[AXIS_6] = 0.5 * (y + (x * h_x2_div_d));
            }
#endif
            break;
  ...
  if (axis_command)
  {
    bit_false(value_dwords, (dwbit(DWORD_X) | dwbit(DWORD_Y) | dwbit(DWORD_Z) | dwbit(DWORD_A) | dwbit(DWORD_B) | dwbit(DWORD_C) | dwbit(DWORD_U) | dwbit(DWORD_V) | dwbit(DWORD_W)));
  } // Remove axis words.
#else
  if (axis_command)
  {
    bit_false(value_dwords, (dwbit(DWORD_X) | dwbit(DWORD_Y) | dwbit(DWORD_Z)));
  } // Remove axis words.
#endif
  if (value_dwords)
  {
  ...
  */
  ...
  if (gc_parser_flags & GC_PARSER_JOG_MOTION)
  {
    ...
    if (command_dwords & ~(bit(MODAL_GROUP_G3) | bit(MODAL_GROUP_G6) | bit(MODAL_GROUP_G0)))
    {
