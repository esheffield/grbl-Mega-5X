...
uint8_t get_step_pin_mask(uint8_t axis_idx)
{
  ...
  if (axis_idx == AXIS_1)
  {
    return ((1 << STEP_BIT(AXIS_1)));
  }
  if (axis_idx == AXIS_2)
  {
    return ((1 << STEP_BIT(AXIS_2)));
  }
#if N_AXIS > 3
  if (axis_idx == AXIS_4)
  {
    return ((1 << STEP_BIT(AXIS_4)));
  }
#endif
#if N_AXIS > 4
  if (axis_idx == AXIS_5)
  {
    return ((1 << STEP_BIT(AXIS_5)));
  }
#endif
#if N_AXIS > 5
  if (axis_idx == AXIS_6)
  {
    return ((1 << STEP_BIT(AXIS_6)));
  }
#endif
...
uint8_t get_direction_pin_mask(uint8_t axis_idx)
{
  ...
  if (axis_idx == AXIS_1)
  {
    return ((1 << DIRECTION_BIT(AXIS_1)));
  }
  if (axis_idx == AXIS_2)
  {
    return ((1 << DIRECTION_BIT(AXIS_2)));
  }
#if N_AXIS > 3
  if (axis_idx == AXIS_4)
  {
    return ((1 << DIRECTION_BIT(AXIS_4)));
  }
#endif
#if N_AXIS > 4
  if (axis_idx == AXIS_5)
  {
    return ((1 << DIRECTION_BIT(AXIS_5)));
  }
#endif
#if N_AXIS > 5
  if (axis_idx == AXIS_6)
  {
    return ((1 << DIRECTION_BIT(AXIS_6)));
  }
#endif
...
uint8_t get_min_limit_pin_mask(uint8_t axis_idx)
{
  if (axis_idx == AXIS_1)
  {
    return ((1 << MIN_LIMIT_BIT(AXIS_1)));
  }
  if (axis_idx == AXIS_2)
  {
    return ((1 << MIN_LIMIT_BIT(AXIS_2)));
  }
#if N_AXIS > 3
  if (axis_idx == AXIS_4)
  {
    return ((1 << MIN_LIMIT_BIT(AXIS_4)));
  }
#endif
#if N_AXIS > 4
  if (axis_idx == AXIS_5)
  {
    return ((1 << MIN_LIMIT_BIT(AXIS_5)));
  }
#endif
#if N_AXIS > 5
  if (axis_idx == AXIS_6)
  {
    return ((1 << MIN_LIMIT_BIT(AXIS_6)));
  }
#endif
...
uint8_t get_max_limit_pin_mask(uint8_t axis_idx)
{
  if (axis_idx == AXIS_1)
  {
    return ((1 << MAX_LIMIT_BIT(AXIS_1)));
  }
  if (axis_idx == AXIS_2)
  {
    return ((1 << MAX_LIMIT_BIT(AXIS_2)));
  }
#if N_AXIS > 3
  if (axis_idx == AXIS_4)
  {
    return ((1 << MAX_LIMIT_BIT(AXIS_4)));
  }
#endif
#if N_AXIS > 4
  if (axis_idx == AXIS_5)
  {
    return ((1 << MAX_LIMIT_BIT(AXIS_5)));
  }
#endif
#if N_AXIS > 5
  if (axis_idx == AXIS_6)
  {
    return ((1 << MAX_LIMIT_BIT(AXIS_6)));
  }
#endif
